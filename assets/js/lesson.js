/* ==========================================================================
   Techbase STEM Academy — HTML Fundamentals course
   Shared lesson interactivity script
   Used by every file in /lessons so all 34 lessons share identical behaviour
   (progress tracking, phase unlocking, copy-to-clipboard, confetti, etc).
